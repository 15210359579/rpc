...
public class SimpleClientRemoteExecutorImpl extends AbstractClientRemoteExecutor implements RemoteExecutor, RpcCallListener, Service {

    private AbstractRpcConnector connector;

    public SimpleClientRemoteExecutorImpl(AbstractRpcConnector connector) {
        super();
