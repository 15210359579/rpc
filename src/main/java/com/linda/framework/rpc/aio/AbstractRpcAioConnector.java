 ...
 */
public class AbstractRpcAioConnector extends AbstractRpcConnector {
    ...
    public AbstractRpcAioConnector() {
        ...
        if (channelGroup == null) {
            try {
                channelGroup = AsynchronousChannelGroup.withThreadPool(
                        Executors.newFixedThreadPool(channelGroupThreads));
            } catch (IOException e) {
    ...
    public void handleFail(Throwable e, AbstractRpcAioConnector connector) {
