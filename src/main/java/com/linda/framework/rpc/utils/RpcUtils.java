...
public class RpcUtils {
    ...
    public static Object invokeMethod(Object obj, String methodName, Object[] args,
                                      RpcExceptionHandler exceptionHandler) {
    ...
    public static void handleException(RpcExceptionHandler rpcExceptionHandler, RpcObject rpc, RemoteCall call,
                                       Exception e) {
    ...
    public static AbstractRpcConnector createRpcConnector(AbstractRpcNioSelector nioSelector,
                                                          AbstractRpcOioWriter writer,
                                                          Class<? extends AbstractRpcConnector> connectorClass) {
        try {
            if (connectorClass == AbstractRpcNioConnector.class) {
                Constructor<? extends AbstractRpcConnector> constructor = connectorClass.getConstructor(
                        AbstractRpcNioSelector.class);
                return constructor.newInstance(nioSelector);
            } else if (connectorClass == AbstractRpcOioConnector.class) {
                Constructor<? extends AbstractRpcConnector> constructor = connectorClass.getConstructor(
                        AbstractRpcOioWriter.class);
