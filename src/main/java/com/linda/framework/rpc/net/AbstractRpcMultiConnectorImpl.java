...
public class AbstractRpcMultiConnectorImpl extends AbstractRpcNet implements Service {
    ...
    private static final Class<? extends AbstractRpcConnector>      DEFAULT_CONNECTOR_CLASS  =
            AbstractRpcNioConnector.class;
    private              Class<? extends AbstractRpcConnector>      connectorClass           = DEFAULT_CONNECTOR_CLASS;
    private              CopyOnWriteArrayList<AbstractRpcConnector> connectors               =
            new CopyOnWriteArrayList<AbstractRpcConnector>();
