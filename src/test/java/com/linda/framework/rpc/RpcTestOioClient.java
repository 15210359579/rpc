...
public class RpcTestOioClient {
    ...
    public static class CallThread extends Thread {
        ...
        public CallThread(HelloRpcService helloRpcService, HelloRpcTestService testService, int count,
    ...
    public static void main(String[] args) {
        ...
        int                  port      = 4332;
        AbstractRpcConnector connector = new AbstractRpcOioConnector(null);
        ...
        for (CallThread thread : ths) {
            logger.info("thread:" + thread.getId() + " time:" + thread.getTime() + " execeptionCount:" +
                        thread.execeptionCount);
        }
    }
