...
public class RpcClientTest {
    ...
    private class ExeThread extends Thread {
        ...
        public void run() {
            ...
            logger.info(
                    "thread:" + Thread.currentThread().getId() + " call:" + call + " fail:" + fail + " cost:" + cost +
                    " sleep:" + sleep);
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        logger.info("callAll:" + call + " threadCount:" + threadCount + " timeAll:" + timeAll + " time:" + myExeTime +
                    " tps:" + tps + " threadTps:" + threadTps + " connections:" + clients);
        System.exit(0);
    }
