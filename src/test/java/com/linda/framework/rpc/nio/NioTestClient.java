...
public class NioTestClient implements RpcCallListener {
    ...
    private AbstractRpcNioConnector connector;
    ...
    public static List<NioTestClient> createClients(SimpleRpcNioSelector selection, String ip, int port, int clients,
                                                    int connectors, int threadCount) {
    ...
    public void startService() {
        if (!started.get()) {
            started.set(true);
            connector = new AbstractRpcNioConnector(selection);
